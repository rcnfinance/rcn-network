...
const TestCosignerDiaspore = artifacts.require('./diaspore/utils/test/TestCosignerDiaspore.sol');
...
contract('Test LoanManager Diaspore', function (accounts) {
    ...
    async function getRequest (id) { //  TODO arreglar
    ...
    before('Create engine and model', async function () {
        ...
        cosigner = await TestCosignerDiaspore.new(rcn.address);
    ...
    describe('Function registerApproveRequest', function () {
        ...
        it('Should register approve using the borrower callback', async function () {
            ...
            assert.equal(await loanManager.isApproved(id), true);//  TODO arreglar
